#!/usr/bin/env python3
"""Focused benchmark for pure-Python pickle save-side batch fast-path ideas."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--variant",
        choices=("baseline", "exact_int_lists", "exact_int_lists_min8"),
        default="baseline",
    )
    ...
    for key in (
        ...
        "S3_nested_list_of_dicts_dump",
        "S4_deep_list_dump",
        "S5_mixed_scalar_list_dump",
        "S6_bool_list_dump",
        "S7_small_int_run_dump",
    ):
        data = results[key]
